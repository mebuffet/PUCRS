#################################################################################
#
# Created by Genus(TM) Synthesis Solution 16.10-p006_1 on Wed Nov 30 18:19:23 -0200 2016
#
#################################################################################

## library_sets
create_library_set -name default_emulate_libset_max \
    -timing { /home/micro2/lab3/synthesis/../characterization/inv.lib \
...
create_constraint_mode -name default_emulate_constraint_mode \
    -sdc_files { layout//TF.default_emulate_constraint_mode.sdc }
